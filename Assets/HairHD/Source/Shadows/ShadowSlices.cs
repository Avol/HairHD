...
public class ShadowSlices
{
    ...
    public ShadowSliceData[] m_AdditionalLightsShadowSlices = null;

    public int[] m_VisibleLightIndexToAdditionalLightIndex = null;                         // maps a "global" visible light index (index to renderingData.lightData.visibleLights) to an "additional light index" (index to arrays _AdditionalLightsPosition, _AdditionalShadowParams, ...), or -1 if it is not an additional light (i.e if it is the main light)
    public int[] m_AdditionalLightIndexToVisibleLightIndex = null;                         // maps additional light index (index to arrays _AdditionalLightsPosition, _AdditionalShadowParams, ...) to its "global" visible light index (index to renderingData.lightData.visibleLights)
    ...
    public ShadowSlices(RenderPassEvent evt)
    {
    ...
    public bool Setup(ref RenderingData renderingData)
    {
        ...
        for (int visibleLightIndex = 0; visibleLightIndex < visibleLights.Length && m_ShadowSliceToAdditionalLightIndex.Count < totalShadowSlicesCount && additionalLightCount < maxAdditionalLightShadowParams; ++visibleLightIndex)
        {
            ...
            var originalLightIndex = visibleLightIndex;
        ...
        int renderTargetWidth = Mathf.NextPowerOfTwo(atlasMaxX);
        int renderTargetHeight = Mathf.NextPowerOfTwo(atlasMaxY);
